object DataModuleCargaRapidaNominas: TDataModuleCargaRapidaNominas
  ...
  object QSubCTANominas: TIBDataSet
    Database = DMRef.BDContab
    Transaction = DMRef.IBT1
    BufferChunks = 32
    CachedUpdates = False
  ...
  object SSubCTANominas: TDataSource
    AutoEdit = False
    DataSet = QSubCTANominas
    Left = 442
    Top = 254
  end
end
