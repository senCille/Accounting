...
type
  TDataModuleIRPF110 = class(TDataModule)
  ...
  TIRPF110Model = class(TCustomModel)
  private
    DM :TDataModuleIRPF110;
  protected
  public
...
var
  DataModuleIRPF110: TDataModuleIRPF110;
...
constructor TIRPF110Model.Create(ADB :TIBDatabase; Initialize :Boolean);
begin
   inherited;
   DM := TDataModuleIRPF110.Create(Application);
   if Initialize then DoInitialize;
end;

function TIRPF110Model.DataModule: TDataModule;
begin
   Result := DM;
end;

destructor TIRPF110Model.Destroy;
begin
   DM.Free;
   inherited;
end;

procedure TIRPF110Model.DoInitialize;
begin
   inherited;
...
procedure TIRPF110Model.Refresh;
begin
