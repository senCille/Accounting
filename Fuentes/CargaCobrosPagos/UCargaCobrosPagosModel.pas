...
type
  TDataModuleCargaCobrosPagos = class(TDataModule)
  ...
  TCargaCobrosPagosModel = class(TCustomModel)
  private
    DM :TDataModuleCargaCobrosPagos;
  protected
  public
...
var
  DataModuleCargaCobrosPagos: TDataModuleCargaCobrosPagos;
...
{ TCargaCobrosPagosModel }

constructor TCargaCobrosPagosModel.Create(ADB :TIBDatabase; Initialize :Boolean);
begin
   inherited;
   DM := TDataModuleCargaCobrosPagos.Create(Application);
   if Initialize then DoInitialize;
end;

function TCargaCobrosPagosModel.DataModule: TDataModule;
begin
   Result := DM;
end;

destructor TCargaCobrosPagosModel.Destroy;
begin
   DM.Free;
   inherited;
end;

procedure TCargaCobrosPagosModel.DoInitialize;
begin
   inherited;
...
procedure TCargaCobrosPagosModel.Refresh;
begin
