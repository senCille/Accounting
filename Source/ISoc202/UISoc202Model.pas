...
type
  TDataModuleISoc202 = class(TDataModule)
  ...
  TISoc202Model = class(TCustomModel)
  private
    DM :TDataModuleISoc202;
  protected
  public
...
var
  DataModuleISoc202: TDataModuleISoc202;
...
constructor TISoc202Model.Create(ADB :TIBDatabase; Initialize :Boolean);
begin
   inherited;
   DM := TDataModuleISoc202.Create(Application);
   if Initialize then DoInitialize;
end;

function TISoc202Model.DataModule: TDataModule;
begin
   Result := DM;
end;

destructor TISoc202Model.Destroy;
begin
   DM.Free;
   inherited;
end;

procedure TISoc202Model.DoInitialize;
begin
   inherited;
...
procedure TISoc202Model.Refresh;
begin
